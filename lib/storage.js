const FIELDS = {
    ...
    player1Birthday: {id: 'player1Birthday', label: 'Joueur·euse 1 - Date de naissance (jj/mm/aaaa)', defaultValue: ''},
    ...
    player2Birthday: {id: 'player2Birthday', label: 'Joueur·euse 2 - Date de naissance (jj/mm/aaaa)', defaultValue: ''},
    ...
    player3Birthday: {id: 'player3Birthday', label: 'Joueur·euse 3 - Date de naissance (jj/mm/aaaa)', defaultValue: ''},
